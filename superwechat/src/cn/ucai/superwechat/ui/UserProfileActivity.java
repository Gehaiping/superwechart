...
//        }).start();
    ...
    private void uploadAppUserAvatar(Intent pidata) {
        File file = saveBitmapFile(pidata);
        L.e(TAG, "file=" + file);
        if (file == null) {
            return;
        }
                            ...
                            if (result != null) {
                                if (result.isRetMsg()) {
                                    ...
                                    if (user != null) {
                                        ...
                                        SuperWeChatHelper.getInstance().saveAppContact(user);
                                        EaseUserUtils.setUserAvatar(UserProfileActivity.this,
    ...
    private File saveBitmapFile(Intent pidata) {
        Bundle extras = pidata.getExtras();
        if (extras != null) {
